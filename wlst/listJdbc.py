...
# URL = 't3://200.14.166.72:10000'
outputDir = '/Users/German/bin/wlst/x'
...
def getLibraryListing(mbeanPosition):
  print 'holamundo2'
  cd(mbeanPosition)
  libraryListing = ls(returnMap='true')
# , returnType='a'  

  print libraryListing
  print 'holamundo3'
...
# , returnType='a'
  ...
  if appListing.size() > 0 :
    ...
    for app in appListing :
      ...
      cd('/AppDeployments/' + appItem)
      print cmo.getAbsoluteSourcePath() # this will list the full path
