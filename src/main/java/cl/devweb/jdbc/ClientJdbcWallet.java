...
public static void main(String[] args) throws SQLException, IOException {
    ...
    //System.setProperty("oracle.net.tns_admin", "C:\\Users\\germagon\\Documents\\tmp\\Wallet_DB202112201424");
    //Wallet unzipped:
    System.setProperty("oracle.net.tns_admin", "C:\\Users\\germagon\\Documents\\tmp\\Wallet_DB202112201424");

    String url = "jdbc:oracle:thin:@db202112201424_tp";
    ds.setURL(url);
    ds.setUser("ADMIN");
  ...
  //  server.createContext("/", (httpExchange) -> {
      ...
      try (OracleConnection conn = (OracleConnection) ds.getConnection();
    	...
    	//System.out.println("conn=" + conn.getcoConnectionAttributes());
